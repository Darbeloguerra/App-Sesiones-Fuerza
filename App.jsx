...
// VUELTO ATRÁS TEMPORALMENTE a Apps Script el 14/09, mientras se termina de
// depurar la capa de Supabase — ver conversación del día para el motivo.
...
// Con Sheets, un número "vacío" y "sin escribir" eran la misma cosa: una
// celda en blanco. En Postgres, cualquier columna numérica exige o un
// número o NULL — un texto vacío "" la rompe. Como el resto de la app
// (tareas sin circuito, tareas sin RIR relleno, etc.) siempre ha mandado
// "" para "no hay valor", esto lo traduce automáticamente para cada
// columna numérica de cada tabla, sin tener que tocar esos sitios uno a
// uno cada vez que aparece uno nuevo.
...
function transformToDb(entity, record) {
  ...
  if (entity === "ejercicios") {
    // Con Sheets, "" y "sin valor" eran lo mismo en esta columna. En
    // Postgres, categoria_preventiva_id es una referencia a otra tabla y
    // no admite texto vacío — solo NULL.
